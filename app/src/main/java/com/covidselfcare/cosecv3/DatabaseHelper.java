...
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        db.execSQL("CREATE TABLE IF NOT EXISTS "+TABLE_NAME + "(ID INTEGER PRIMARY KEY AUTOINCREMENT, USERNAME TEXT , GENDER TEXT ,AGE TEXT, PASSWORD TEXT,RISK TEXT DEFAULT 0, ANS1 TEXT DEFAULT 'NO',ANS2 TEXT DEFAULT 'NO',ANS3 TEXT DEFAULT 'NO')");
    }
